...
describe("Signature API Integration Tests", () => {
    ...
    beforeEach(async () => {
        ...
        mockFileStorageService.generateFileName.mockReturnValue("signature_test_123_1640995200000.png");
        mockFileStorageService.saveSignature.mockResolvedValue("signature_test_123_1640995200000.png");
    ...
    describe("GET /api/signature", () => {
        it("should get all signatures successfully", async () => {
            // Arrange
            const mockSignatures = [mockSignature, { ...mockSignature, ID: "signature_test_456" }];
