...
<template>
  ...
  <v-container fluid class="d-flex pa-0">
    <!-- Bagian Kiri (Gambar) -->
    <v-container
      class="d-none d-sm-flex align-center justify-center bg-primary h-screen w-75"
    >
      <v-img
    ...
    <v-container
      class="d-flex align-center justify-center h-screen w-100 sm-w-50"
    >
      <v-card class="pa-6 bg-white" width="400">
        <v-card-title class="text-center my-4"> Selamat Datang </v-card-title>
        <v-card-text>
          <v-btn block color="primary" @click="console.log('clicked')">
